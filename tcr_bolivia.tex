...
iii. Ratio entre los salarios del sector transable y no transable, en esencia se espera que este indicador brinde nociones similares a la razón de precios. No obstante, un impedimento hará referencia a la disponibilidad de información y la poca frecuencia en la publicación de la misma. 
Con relación a los pasivos externos netos, se sigue la metodología propuesta por Lane y Mileesi-Ferreti (2002), cuya aproximación se realiza a partir del stock de deuda externa, reservas internacionales y el saldo de la cuenta corriente. Sin embargo, como una medida alterna que permite la comparación y el control se utiliza el saldo de la cuenta corriente como un proxy para los pasivos externos netos.  
El gasto de gobierno es analizado desde tres perspectivas: i. En un primer enfoque se compara el gasto de gobierno de Bolivia con el gasto de gobierno de sus principales socios comerciales. Cabe aclarar que el gasto de gobierno ingresa como porcentaje del PIB, de esta manera las variables resultan comparables y se evita posibles sesgos vinculados al tamaño de la información, la agregación del gasto de gobierno de los socios comerciales se la realiza como un promedio ponderado que esta en función de su peso comercial con Bolivia. 
ii. En una segunda medida se considera unicamente el gasto de gobierno en bienes no transables como porcentaje del PIB, esta medida es bastante interesante para el análisis, ya que se evaluan las presiones al tipo de cambio real en linea con el nivel de consumo que realiza el gobierno en bienes no transables. 
iii. La tercera medida evalúa el gasto de gobierno total como porcentaje del PIB. 
El resto de variables, como el tipo de cambiro real y los términos de intercambio son las que publica el Banco central de Bolivia. Para la estimación se cuenta entonces con información trimestral desde 1991 hasta 2017. Sin embargo en algunos casos las variables muestran cambios en su volatilidad lo que no hace posible la comparación de propiedades estadisticas, debido a ello la estimación se la realiza desde 2004 hasta 2017 rango de fecha para el cual existe mayor estabilidad en el comportamiento de las variables consideradas fundamentos.

Previo a realizar la estimación se efectúa un análisis sencillo de correlaciones cruzadas, dos objetivos resultan de este apartado preliminar, primero documentar las principales regularidades de las variables escogidas como fundamentos con el Tipo de Cambio Real, identificando las máximas correlaciones y la dirección del co-movimiento, este análisis brindará noción sobre los signos que se esperarían de la estimación, y de la consistencia del modelo con la evidencia empírica. 
