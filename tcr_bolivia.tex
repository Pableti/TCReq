...
Sin embargo con la finalidad de que la dinamica multivariada del TCRE, no sea definida por tuición, la estimación que se presenta sigue contribuciones previas de \cite{rogoff1995exchange} con relación a la versión transable y no transable y la incorporación del Gobierno propuesta en \cite{calderon2004exchange}. Segun dicha especificación el TCR de equilibrio será definido a partir 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% completando
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%esa línea la ecuación del tipo de cambio    
